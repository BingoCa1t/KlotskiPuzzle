package com.klotski.aigo;//Valerie Cook, Jennifer Dai, Daniel Radding, Yangzi He
    ...
    private ArrayList<MoveStep> printSolution() {
        ...
        if (solved == false) {
            ...
            while (!currentNode.myChildren.isEmpty()) {
                ...
                int destinationColumn = currentNode.myMove.newUpperColumn;
                int originRow = currentNode.myMove.oldUpperRow;
                int originColumn = currentNode.myMove.oldUpperColumn;
                Pos originPos = new Pos(originRow, originColumn);
                Pos destinationPos = new Pos(destinationRow, destinationColumn);
                MoveStep step = new MoveStep(originPos, destinationPos);
                solution.add(step);
